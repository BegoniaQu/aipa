 ...
 *
 */
public class InvalidRequestRuntimeException extends CloudPlatformRequestRuntimeException {
	...
	public InvalidRequestRuntimeException(String msg, int err) {
		super(msg, err, HttpStatus.UNPROCESSABLE_ENTITY);
	}
	
	public InvalidRequestRuntimeException(String msg, int err, Throwable cause) {
		super(msg, err, HttpStatus.UNPROCESSABLE_ENTITY, cause);
	}
